...
export type PrescriptionRowNurse = {
  id: string;
...
type MedicationTableNurseProps = {
  prescriptions: PrescriptionRowNurse[];
  ...
  onAdminister: (rx: PrescriptionRowNurse) => void;
};
...
export default function MedicationTableNurse({
  prescriptions,
  displayForRouteCode,
  displayForFrequencyCode,
  onViewHistory,
  onAdminister,
}: MedicationTableNurseProps) {
      ...
      >
        <thead>
          <tr>
            ...
            <th style={{ ...headerCellStyle, textAlign: "right", width: 260 }}>
              Actions
            </th>
          </tr>
        </thead>
  ...
  {routeLines.length ? (
    ...
    <div>{rx.route || "—"}</div>
                ...
                >
                  ...
                  >
                    {rx.available_for_administration &&
